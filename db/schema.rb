...
ActiveRecord::Schema.define(version: 20170125091709) do
  ...
  create_table "applications", force: :cascade do |t|
    ...
    t.index ["followed_id"], name: "index_applications_on_followed_id"
    t.index ["follower_id", "followed_id"], name: "index_applications_on_follower_id_and_followed_id", unique: true
    t.index ["follower_id"], name: "index_applications_on_follower_id"
  end
